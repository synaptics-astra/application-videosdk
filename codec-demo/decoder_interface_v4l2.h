#ifndef _DECODER_INTERFACE_V4L2_H_
#define _DECODER_INTERFACE_V4L2_H_
...
typedef struct
{
	...
	int			mmap_virtual_output_sharedFDs[H264_DEC_OUT_BUF_COUNT_MAX];
}priv_v4l2_decoder_t;

#endif //_DECODER_INTERFACE_V4L2_H_
